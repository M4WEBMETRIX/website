<section id="clients" class="section-bg">
    ...
    <div class="container">
        ...
        <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
                <div class="client-logo">
                    <img src="{{asset('asset/img/clients/client-4.png')}}{{asset('asset/img/clients/client-8.png')}}" class="img-fluid" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
                <div class="client-logo">
                    <img src="{{asset('asset/img/clients/client-7.png')}}" class="img-fluid" alt="">
                </div>
            </div>

            <div class="col-lg-3 col-md-4 col-xs-6">
                <div class="client-logo">
                    <img src="{{asset('asset/img/clients/client-8.png')}}" class="img-fluid" alt="">
                </div>
            </div>
